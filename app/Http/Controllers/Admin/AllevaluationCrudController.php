 ...
 */
class AllevaluationCrudController extends CrudController
{
        ...
        public function setup()
        {
            ...
            CRUD::setRoute(config('backpack.base.route_prefix') . '/allevaluation');
            CRUD::setEntityNameStrings('Evaluation', 'Evaluation');
        ...
        {          
            ...
            $this->crud->addClause('where', 'communication_types_id', '=', 'Evaluation');
