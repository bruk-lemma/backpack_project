 ...
 */
class Lead_complainCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/lead_complain');
    ...
    {
              $this->crud->addClause('where', 'type', '=', 'lead');
  ...
  // $id=auth::guard('backpack')->user('name')->id;
    ...
    protected function setupUpdateOperation()
    {
      $this->crud->setUpdateContentClass('col-md-12');
        ...
        $this->crud->addButtonFromView('top', 'LeadConvert', 'LeadConvert', 'beginning');
    }
       ...
       $this->crud->addColumn([
        ...
        $this->crud->addColumn([
          ...
          //   ]);      
            ...
            $this->crud->addButtonFromView('line', 'all_complain', 'all_complain', 'beginning');
            // $this->crud->addButtonFromView('line', 'all_meeting', 'all_meeting', 'beginning');
            // $this->crud->addButtonFromView('line', 'all_call', 'all_call', 'beginning');
            // $this->crud->addButtonFromView('line', 'all_task', 'all_task', 'beginning');
