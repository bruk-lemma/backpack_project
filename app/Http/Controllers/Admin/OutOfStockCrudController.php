 ...
 */
class OutOfStockCrudController extends CrudController
   {
        ...
        public function setup()
        {
            ...
            CRUD::setRoute(config('backpack.base.route_prefix') . '/outofstock');
            CRUD::setEntityNameStrings('Out Of Stock', 'Out Of Stock');
        ...
        protected function setupListOperation()
        {
            ...
            $this->crud->addClause('where', 'communication_types_id', '=', 'Out Of Stock');
