 ...
 */
class LeadshowCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
              ...
              $this->crud->addButtonFromView('line', 'leadshow', 'leadshow', 'begining');
              // $this->crud->addButtonFromView('top', 'leadcall', 'leadcall', 'begining');
              // $this->crud->addButtonFromView('top', 'leadmeet', 'leadmeet', 'begining');
              // $this->crud->addButtonFromView('top', 'leadnote', 'leadnote', 'begining');
