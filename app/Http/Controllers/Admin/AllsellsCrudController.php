 ...
 */
class AllsellsCrudController extends CrudController
{
        ...
        public function setup()
        {
            ...
            CRUD::setRoute(config('backpack.base.route_prefix') . '/allsells');
        ...
        {          
            ...
            $this->crud->addClause('where', 'communication_types_id', '=', 'Sells');  
