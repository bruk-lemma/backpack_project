...
class CustomerCrudController extends CrudController
{
  ...
  // $id=auth::guard('backpack')->user('name')->id;
    ...
    protected function setupListOperation()
    {
        ...
        $this->crud->addClause('where', 'type', '=', 'Customer');
      //  CRUD::setFromDb();
...
'value' => Auth::guard('backpack')->user()->name
      ...
      protected function setupShowOperation()
      {
        ...
        $this->crud->addButtonFromView('left1', 'allsells', 'allsells', 'beginning');
        ...
        $this->crud->addButtonFromView('right1', 'newsells', 'newsells', 'beginning');
...
$this->crud->addColumn([
  ...
  'type' => 'text',
  'label' => "Contact_Converted_By",

]);
$this->crud->addColumn([
  'name' => 'Contact_Converted_date',
  'type' => 'datetime',
  'label' => "Contact Converted Date",
  ]);
