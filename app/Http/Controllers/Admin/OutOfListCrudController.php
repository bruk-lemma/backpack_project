 ...
 */
class   OutOfListCrudController  extends CrudController
{
    ...
    // use \Backpack\CRUD\app\Http\Controllers\Operations\CreateOperation;
        ...
        public function setup()
        {
            ...
            CRUD::setRoute(config('backpack.base.route_prefix') . '/outoflist');
            CRUD::setEntityNameStrings('Out Of List', 'Out Of Lists');
        ...
        protected function setupListOperation()
        {
            ...
            $this->crud->addClause('where', 'communication_types_id', '=', 'Out Of List');
