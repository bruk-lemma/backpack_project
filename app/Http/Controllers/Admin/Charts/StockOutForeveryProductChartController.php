...
/**
 * Class StockOutForeveryProductChartController
 * @package App\Http\Controllers\Admin\Charts
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class StockOutForeveryProductChartController extends ChartController
{
    public function setup()
    {
     ...
     //[$Certificate, $Special_Paper,$ATM_Flash_8GB,$ATM_Flash_32GB,$Mouse_Pad_3mm,$Mouse_Pad_2mm,$Cup_Coaster, $MDF_1_Side_Board,$MDF_2_Side_Board,$Photo_Album]
       ...
       // [$Bamboo_Frame_15_10, $Bamboo_Frame_17_17,$Bamboo_Aluminium_Sheet_15_25,$Silcon_Pad_38_38,$Silcon_Pad_40_60,$Mug_Box, $Stamp_Rubber,$Mold_11_oz_Long,$Mold_11_oz_Short,$Mold_9_oz]
        ...
        $this->chart = new Chart();
        $this->chart->labels(["White_Pen","Silver_Pen","Leo_Pen","Sublimation_Pen","Sanitizer_Pen","White_Mug"," Magic_Mug","Color_Mug"," Silver_Mug","Golden_Mug","
        Thermos_Mug","Sport_Mug_300ml","Travel_Mug_600ml","Mirror_Silver_Mug ","Mirror_Golden_Mug","Black_Frame_Mug","V_Shape_Mug","Enamel_Mug","Mason_jar_Mug","Copper_Mug","
        Sublimation_Metal_Key_Chain","MDF_Key_Chain_1_Side","MDF_Key_Chain_2_Side","Key_Chain_Metal_1_Side","Binding_Machine","  Mug_Machine","Lamination_Machine_A3","Heat_Press_Machine_38_A3"," Portable_Heat_Press_Machine","Five_in_one_Heat_Press","
        Mug_Machine_Five_in_one","Flash_Stamp_Machine","Pen_Machine","Id_Cutter","Cap_Machine","Desk_Mate_Stamp","Epson_Printer_Machine_L382","Epson_Printer_Machine_L805"," Transfer_Paper_Light","Transfer_Paper_Dark","
        Certificate"," Special_Paper","ATM_Flash_8GB","ATM_Flash_32GB","Mouse_Pad_3mm","Mouse_Pad_2mm","Cup_Coaster"," MDF_1_Side_Board","MDF_2_Side_Board","Photo_Album","
        ...
        Bamboo_Frame_15_10"," Bamboo_Frame_17_17","Bamboo_Aluminium_Sheet_15_25","Silcon_Pad_38_38","Silcon_Pad_40_60","Mug_Box"," Stamp_Rubber","Mold_11_oz_Long","Mold_11_oz_Short","Mold_9_oz","
        Mold_6_oz","MDF_Wine_Box","Art_Knife","Name_Tag","Stamp_20_50","Stamp_30_60"," Crystal_Stamp","Mold_V_Shaped","T_Shirt_Guide","Vinly_Tool","Tagging_Gun","Tag_Pin"]);
        $this->chart->dataset('My dataset','line',
        ...
        /*->backgroundcolor([
            'rgb(0,0,0)','rgb(255,255,255)','rgb(255,0,0)','rgb(0,255,0)','rgb(0,0,255)','rgb(255,255,0)','rgb(0,255,255)','rgb(255,0,255)','rgb(192,192,192)',
            'rgb (128,128,128)','rgb(128,0,0)','rgb (128,128,0)','rgb(0,128,0)','rgb(128,0,128)','rgb(0,128,128)','rgb(0,0,128)','rgb(139,0,0)','rgb(165,42,42)',
            'rgb(178,34,34)','rgb(220,20,60)','rgb(255,0,0)','rgb(255,99,71)','rgb(255,127,80)','rgb(205,92,92)','rgb(240,128,128)','rgb(233,150,122)','rgb(250,128,114)',
            'rgb(255,160,122)','rgb(255,69,0)','rgb(255,140,0)','rgb(255,165,0)','rgb(255,215,0)','rgb(184,134,11)','rgb(218,165,32)','rgb(238,232,170)','rgb(189,183,107)',
            'rgb(240,230,140)','rgb(128,128,0)','rgb(255,255,0)','rgb(154,205,50)','rgb(85,107,47)','rgb(107,142,35)','rgb(124,252,0)','rgb(127,255,0)','rgb(173,255,47)',
            'rgb(0,100,0)','rgb(0,128,0)','rgb(34,139,34)','rgb(0,255,0)','rgb(50,205,50)','rgb(144,238,144)','rgb(152,251,152)','rgb(143,188,143)','rgb(0,250,154)','rgb(0,255,127)',
            'rgb(46,139,87)','rgb(102,205,170)','rgb(60,179,113)','rgb(32,178,170)','rgb(47,79,79)','rgb(0,128,128)','rgb(0,139,139)','rgb(0,255,255)','rgb(0,255,255)','rgb(224,255,255)',
            'rgb(0,206,209)','rgb(64,224,208)','rgb(72,209,204)','rgb(175,238,238)','rgb(127,255,212)','rgb(176,224,230)','rgb(95,158,160)','rgb(70,130,180)','rgb(100,149,237)','rgb(0,191,255)',
            'rgb(30,144,255)','rgb	(173,216,230)','rgb(135,206,235)','rgb(135,206,250)','rgb(25,25,112)','rgb(0,0,128)','rgb(0,0,139)','rgb(0,0,205)','rgb(0,0,255)','rgb(65,105,225)','rgb(138,43,226)','rgb	(75,0,130)',
            'rgb(72,61,139)','rgb(106,90,205)','rgb(123,104,238)','rgb(147,112,219)','rgb(139,0,139)','rgb(148,0,211)','rgb(153,50,204)','rgb(186,85,211)','rgb	(128,0,128)','rgb(216,191,216)','rgb(221,160,221)','rgb(238,130,238)','rgb(255,0,255)',
            'rgb(218,112,214)','rgb(199,21,133)','rgb(219,112,147)','rgb(255,20,147)','rgb(255,105,180)','rgb(255,182,193)','rgb(255,192,203)','rgb	(250,235,215)','rgb(139,69,19)',
            'rgb(218,112,214)','rgb(199,21,133)','rgb(219,112,147)','rgb(255,20,147)','rgb(255,105,180)','rgb(255,182,193)','rgb(255,192,203)','rgb	(250,235,215)','rgb(139,69,19)','rgb(210,105,30)','rgb(119,136,153)','rgb(128,128,128)',

        ])*/;

        $this->chart->load(backpack_url('charts/stock_out_forevery_product'));
        // OPTIONAL
