            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-success">
                  ...
                  <div id="card-chart2-tooltip" class="chartjs-tooltip top bottom" style="opacity: 0; left: 175.89px; top: 124.979px;"><div class="tooltip-header"><div class="tooltip-header-item">April</div></div><div class="tooltip-body"><div class="tooltip-body-item"><span class="tooltip-body-item-color" style="background-color: rgb(70, 127, 208);"></span><span class="tooltip-body-item-label">My First dataset</span><span class="tooltip-body-item-value">17</span></div></div></div></div>
                </div>
              </div>
              <!-- /.col-->
              <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-warning">
                  ...
                  <div id="card-chart3-tooltip" class="chartjs-tooltip top bottom" style="opacity: 0; left: 162.667px; top: 142.2px;"><div class="tooltip-header"><div class="tooltip-header-item">May</div></div><div class="tooltip-body"><div class="tooltip-body-item"><span class="tooltip-body-item-color" style="background-color: rgba(255, 255, 255, 0.2);"></span><span class="tooltip-body-item-label">My First dataset</span><span class="tooltip-body-item-value">34</span></div></div></div></div>
                </div>
              </div>
              <!-- /.col-->
              <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-dark">
                  ...
                  <div id="card-chart4-tooltip" class="chartjs-tooltip top bottom" style="opacity: 0; left: 224.688px; top: 157.6px;"><div class="tooltip-header"><div class="tooltip-header-item">November</div></div><div class="tooltip-body"><div class="tooltip-body-item"><span class="tooltip-body-item-color" style="background-color: rgba(255, 255, 255, 0.2);"></span><span class="tooltip-body-item-label">My First dataset</span><span class="tooltip-body-item-value">12</span></div></div></div></div>
                </div>
              </div>
              <!-- /.col-->
            </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="chart-wrapper" style="height:300px;margin-top:40px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                  <canvas class="chart chartjs-render-monitor" id="main-chart" height="300" width="1022" style="display: block; width: 1022px; height: 300px;"></canvas>
                <div id="main-chart-tooltip" class="chartjs-tooltip center top" style="opacity: 0; left: 582.537px; top: 309.604px;"><div class="tooltip-header"><div class="tooltip-header-item">F</div></div><div class="tooltip-body"><div class="tooltip-body-item"><span class="tooltip-body-item-color" style="background-color: rgba(70, 127, 208, 0.1);"></span><span class="tooltip-body-item-label">My First dataset</span><span class="tooltip-body-item-value">64</span></div><div class="tooltip-body-item"><span class="tooltip-body-item-color" style="background-color: transparent;"></span><span class="tooltip-body-item-label">My Second dataset</span><span class="tooltip-body-item-value">91</span></div><div class="tooltip-body-item"><span class="tooltip-body-item-color" style="background-color: transparent;"></span><span class="tooltip-body-item-label">My Third dataset</span><span class="tooltip-body-item-value">65</span></div></div></div></div>
              </div>
                ...
                <div class="brand-card">
                  <div class="brand-card-header bg-facebook"><i class="fa fa-facebook"></i>
                    <div class="chart-wrapper"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      <canvas id="social-box-chart-1" height="96" width="242" style="display: block; width: 242px; height: 96px;" class="chartjs-render-monitor"></canvas>
                    </div>
                  </div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="brand-card">
                  <div class="brand-card-header bg-twitter"><i class="fa fa-twitter"></i>
                    <div class="chart-wrapper"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      <canvas id="social-box-chart-2" height="96" width="242" style="display: block; width: 242px; height: 96px;" class="chartjs-render-monitor"></canvas>
                    </div>
                  </div>
                  <div class="brand-card-body">
                    <div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="brand-card">
                  <div class="brand-card-header bg-linkedin"><i class="fa fa-linkedin"></i>
                    <div class="chart-wrapper"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      <canvas id="social-box-chart-3" height="96" width="242" style="display: block; width: 242px; height: 96px;" class="chartjs-render-monitor"></canvas>
                    </div>
                  </div>
                  <div class="brand-card-body">
                    <div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="brand-card">
                  <div class="brand-card-header bg-google-plus"><i class="fa fa-google-plus"></i>
                    <div class="chart-wrapper"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      <canvas id="social-box-chart-4" height="96" width="242" style="display: block; width: 242px; height: 96px;" class="chartjs-render-monitor"></canvas>
                    </div>
                  </div>
                  <div class="brand-card-body">
                    <div>
